...
BOT_TOKEN = environ.get('BOT_TOKEN', "7196376388:AAEVVMkgUV7O3m829dFMOlZuG__5DdFYjT8")
...
STREAM_SITE = (environ.get('STREAM_SITE', '2ad.ir'))
STREAM_API = (environ.get('STREAM_API', '5d8f273dd7f30d58b5b8a20d19d0c2b8791b6113'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6975699357 1001627516').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002031153057').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002118059497') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bestha:12301230@bestha.aaudq2o.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002039291217')) #Log channel id ( make sure bot is admin )
