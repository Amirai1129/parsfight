...
API_ID = int(environ.get('API_ID', '25447929'))
API_HASH = environ.get('API_HASH', '692752fd53f92e7ae3196d0055f43a58')
BOT_TOKEN = environ.get('BOT_TOKEN', "7793799273:AAFFM0pzj56WEwsp0h2XZplht52rdxysSTE")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.postimg.cc/CKNpRyqK/photo-2025-03-16-21-22-01.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7870426686').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002039291217'))
...
MSG_ALRT = environ.get('MSG_ALRT', 'پیشرفته ترین ربات فیلم و سریال')
...
LANGUAGES = ["زیرنویس جداگانه", "srt", "سافت ساب", "softsub" ,"هاردساب", "hardsub", "دوبله فارسی", "duble"]
